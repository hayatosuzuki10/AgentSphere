...
import primula.util.KeyValuePair;
	...
	public class tspdfs18 extends AbstractAgent implements IMessageListener 

    {
    	private int size=18, start;
...
System.out.println();
               ...
               // for (int i=1; i<maxsize; i++){
        		...
        		System.out.println("Elapsed milliseconds to send: " + difference2);
        		long lStartTime3 = System.currentTimeMillis();
        		this.backup();
        		long lEndTime3 = System.currentTimeMillis();
        		long difference3 = lEndTime3 - lStartTime3;
        		System.out.println("Elapsed milliseconds to backup: " + difference3);
