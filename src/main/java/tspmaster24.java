...
public class tspmaster24 extends AbstractAgent implements IMessageListener{
...
private int count=0;
	private boolean finish=false;
	 ...
	 tspdfs24 slave1=new tspdfs24();
	 tspdfs24 slave2=new tspdfs24();
	 tspdfs24 slave3=new tspdfs24();
     ...
     //   adjacency_matrix=adjacency_matrix1;
		  ...
		  for (int i=0; i<number_of_nodes;i++)
		  {
		  	...
		  	Matrix[i][j]=Matrix[j][i];}
		                  ...
		                  slave2.setattr(Matrix, getStrictName(), 9);
		                  slave3.setattr(Matrix, getStrictName(), 17);
