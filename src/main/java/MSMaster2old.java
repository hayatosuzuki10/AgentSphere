...
public class MSMaster2old extends AbstractAgent implements IMessageListener{
	...
	boolean[] sCheck = {false, false};


	 MSSlave2old slave1=new MSSlave2old();
	 MSSlave2old slave2=new MSSlave2old();
