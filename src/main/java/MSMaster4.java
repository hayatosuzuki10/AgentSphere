...
public class MSMaster4 extends AbstractAgent implements IMessageListener{
	...
	long pack[] = new long[4];
	 ...
	 MSSlave4 slave1=new MSSlave4();
	 MSSlave4 slave2=new MSSlave4();
	 MSSlave4 slave3=new MSSlave4();
	 MSSlave4 slave4=new MSSlave4();
...
*/
	...
	public void receivedMessage(AbstractEnvelope envelope) {
		...
		CommunicateTime = pack[0];
		resultTime = (EndTime - pack[3]);
		...
		if(playCount != 500) {
			...
			NBoard.setattr(mMinefield, mineNum, getStrictName(), 0);

			System.out.println("M: Sending -> S");
			StandardEnvelope env1 = new StandardEnvelope(new AgentAddress(slave1.getStrictName()), new StandardContentContainer(NBoard));
